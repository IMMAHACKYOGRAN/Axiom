...
namespace Axiom {
	...
	void ImGuiLayer::OnEvent(Event& e)
	{
		...
		dispatcher.Dispatch<MouseMovedEvent>(AX_BIND_EVENT_FN(ImGuiLayer::OnMouseMoveEvent));
		dispatcher.Dispatch<MouseScrolledEvent>(AX_BIND_EVENT_FN(ImGuiLayer::OnMouseScrollEvent));
		...
		dispatcher.Dispatch<WindowResizeEvent>(AX_BIND_EVENT_FN(ImGuiLayer::OnWindowResized));
